  ...
  return (
    <div className="w-full relative bg-[url('/paralax-bg.jpg')] bg-no-repeat bg-cover min-h-screen">
        ...
        <div className="md:hidden">
          <motion.img style={{y}} src='cloud.png' alt='cloud' className='absolute top-52 left-0' width={200} />
          <motion.img style={{y}} src='cloud.png' alt='cloud' className='absolute top-52 left-0' width={200} />
          <motion.img style={{y}} src='cloud.png' alt='cloud' className='absolute top-52 left-0' width={200} />
          <motion.img style={{y}} src='cloud2.png' alt='cloud' className='absolute top-1/2 right-2' width={400} />
          <motion.img style={{y}} src='cloud2.png' alt='cloud' className='absolute top-1/2 right-2' width={400} />
          <motion.img style={{y}} src='cloud2.png' alt='cloud' className='absolute top-1/2 right-2' width={400} />
        </div>
        ...
        <div className="mt-32 h-full min-h-[80vh] lg:mt-60 z-10 lg:min-h-screen max-w-screen-xl mx-auto relative flex flex-col lg:flex-row justify-between">
          <div className='space-y-4 lg:space-y-8 p-2'>
            ...
            <p className='text-md lg:text-xl max-w-xl'>Revanta Homes is a project by Rishabhdeo Builders & Developers. They build homes with timeless designs. Thet build homes which are beyond your dreams.</p>
          </div>
